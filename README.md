...
The root URL is the actual game lobby. The construction build supports a real 3–4 player Firebase room, unique power-free Commander identities, deterministic setup, and private starting hands on the production board. All 22 board destinations, all nine Scout posts, twelve complete Battles, five starting-card Agent boxes, the first six Chronicle instances, all six Plot Fate definitions, and all six Combat Fate definitions are live. The implemented economy includes every faction and White Council destination, Minas Tirith, Edoras, Fangorn Moot, Deep Fangorn, Entwash, standing rewards, Alliances, ordered choices, deck changes, and finite pieces. Combat includes deployment, private Fate effects, ranked rewards, ties, Standards, critical-location control, and cleanup. Defence of Dale awards its exact White Tree Standard, Renown, and Dwarven standing through the ordinary Battle loop. Last March of the Ents awards its exact Horse Standard and resources while permanently breaching the Dam. Fell Sorcery pays its exact Mithril cost, preserves a reloadable opponent choice, and applies a clamped three-Strength loss without surrendering Combat authority. Riches independently accumulate at Edoras, Deep Fangorn, and Entwash while each is empty. Players can obtain Ent-draught, prove that an intact Dam protects a critical Battle, permanently breach the Dam, summon Ents, and receive doubled ranked rewards. Players can also keep a public five-card Chronicle Row, Reveal, acquire and later draw Chronicle or Reserve cards, cycle an affordable exact Row card with Long Memory, Recall, rotate first player, and replay every accepted event after reload. Unimplemented content remains visibly unavailable.
