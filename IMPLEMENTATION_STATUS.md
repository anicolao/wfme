...
| Board destinations | 15 / 22 | All eight faction destinations, five White Council destinations, Take Up a War Effort, and Minas Tirith are executable; the other seven are disabled |
...
| Fate physical instances | 30 / 30; effects 8 / 30 | Deterministically shuffled deck, private hands, public discard, keep-one choice, deterministic transfer and cycle, conservation, and replay; both copies of Sudden Charge, Hold the Line, Hidden Archers, and Reinforcements are fully playable during Combat |
| Battle cards | 3 / 16 | Crossing of the Isen, Siege of Minas Tirith, and Battle of the Pelennor Fields have final setup, Standards, all ranked rewards, ownership/discard, and cleanup |
