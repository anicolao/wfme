...
| Board destinations | 6 / 22 | Two faction spaces, Take Up a War Effort, and all three reviewed White Council spaces; the other 16 are disabled |
...
Tracer 2 continues with the remaining ordinary Agent-space families, beginning with Pits of Isengard. Reveal and Recall provide the genuine multi-round path needed to exercise costs, standing thresholds, Scouts, and later-acquired cards without manufactured state.
