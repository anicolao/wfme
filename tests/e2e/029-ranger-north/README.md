# Test: Ranger of the North private discard
...
- [x] The exact physical Ranger enters discard and its public Row position refills
...
- [x] The printed Roads icon enables the final Take Up a War Effort destination
