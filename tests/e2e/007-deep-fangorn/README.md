...
## Mara enters an Ent journey room code

![Phone: Mara enters an Ent journey room code](./screenshots/001-host-code-phone.png)

![Desktop: Mara enters an Ent journey room code](./screenshots/001-host-code-desktop.png)

**Verifications:**

- [x] The invitation code is visible
...
- [x] The room is live in Firebase
...
- [x] The independent browser retains its name

---

## Rin enters the invitation code

![Phone: Rin enters the invitation code](./screenshots/004-guest-1-code-phone.png)

![Desktop: Rin enters the invitation code](./screenshots/004-guest-1-code-desktop.png)

**Verifications:**

- [x] The independent browser uses the exact room code
...
- [x] Every connected lobby sees the new seat
...
## Pip enters the invitation code

![Phone: Pip enters the invitation code](./screenshots/007-guest-2-code-phone.png)

![Desktop: Pip enters the invitation code](./screenshots/007-guest-2-code-desktop.png)
...
- [x] The Commander selection is public and unique
...
- [x] The Ranger choice closes without trashing
...
- [x] Ent-draught ownership, recruitment, and Provision are public
