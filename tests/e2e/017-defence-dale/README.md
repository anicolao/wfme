# Test: Defence of Dale as a selected Age II Battle

Three isolated humans reveal through the Age I Battle, see Defence of Dale selected from the shuffled Age II cards, enter with Reconnaissance, place its Scout, deploy a finite Company, Reveal, win through the sole-participant Combat window, receive exactly one Renown and one Dwarven standing, and reload the converged trophy and next round.
...
- [x] The selected Age II Battle opens in round two
- [x] Every connected browser replays 16 accepted events with no diagnostics

---

## Mara chooses Reconnaissance for Defence of Dale

![Phone: Mara chooses Reconnaissance for Defence of Dale](./screenshots/023-choose-dale-reconnaissance-phone.png)

![Desktop: Mara chooses Reconnaissance for Defence of Dale](./screenshots/023-choose-dale-reconnaissance-desktop.png)

**Verifications:**

- [x] The printed Stronghold icon enables Minas Tirith

---

## Mara enters the Battle through Minas Tirith

![Phone: Mara enters the Battle through Minas Tirith](./screenshots/024-enter-dale-through-minas-phone.png)

![Desktop: Mara enters the Battle through Minas Tirith](./screenshots/024-enter-dale-through-minas-desktop.png)

**Verifications:**

- [x] Every observer sees the Agent while Reconnaissance interrupts with its Scout
- [x] Every connected browser replays 17 accepted events with no diagnostics

---

## Mara places the Reconnaissance Scout

![Phone: Mara places the Reconnaissance Scout](./screenshots/025-place-dale-scout-phone.png)

![Desktop: Mara places the Reconnaissance Scout](./screenshots/025-place-dale-scout-desktop.png)

**Verifications:**

- [x] The finite Scout is public before ordered Battle deployment
- [x] Every connected browser replays 18 accepted events with no diagnostics

---

## Mara deploys one Company to Defence of Dale

![Phone: Mara deploys one Company to Defence of Dale](./screenshots/026-deploy-dale-company-phone.png)

![Desktop: Mara deploys one Company to Defence of Dale](./screenshots/026-deploy-dale-company-desktop.png)

**Verifications:**

- [x] Every observer sees one real Company at the named Battle
- [x] Every connected browser replays 19 accepted events with no diagnostics

---

## Pip Reveals for Defence of Dale

![Phone: Pip Reveals for Defence of Dale](./screenshots/027-dale-reveal-1-phone.png)

![Desktop: Pip Reveals for Defence of Dale](./screenshots/027-dale-reveal-1-desktop.png)
...
## Pip finishes the Defence of Dale Reveal

![Phone: Pip finishes the Defence of Dale Reveal](./screenshots/028-dale-finish-1-phone.png)

![Desktop: Pip finishes the Defence of Dale Reveal](./screenshots/028-dale-finish-1-desktop.png)
...
## Rin Reveals for Defence of Dale

![Phone: Rin Reveals for Defence of Dale](./screenshots/029-dale-reveal-2-phone.png)

![Desktop: Rin Reveals for Defence of Dale](./screenshots/029-dale-reveal-2-desktop.png)
...
## Rin finishes the Defence of Dale Reveal

![Phone: Rin finishes the Defence of Dale Reveal](./screenshots/030-dale-finish-2-phone.png)

![Desktop: Rin finishes the Defence of Dale Reveal](./screenshots/030-dale-finish-2-desktop.png)
...
## Mara Reveals for Defence of Dale

![Phone: Mara Reveals for Defence of Dale](./screenshots/031-dale-reveal-3-phone.png)

![Desktop: Mara Reveals for Defence of Dale](./screenshots/031-dale-reveal-3-desktop.png)
...
## Mara finishes the Defence of Dale Reveal

![Phone: Mara finishes the Defence of Dale Reveal](./screenshots/032-dale-finish-3-phone.png)

![Desktop: Mara finishes the Defence of Dale Reveal](./screenshots/032-dale-finish-3-desktop.png)
...
## Mara passes and wins Defence of Dale

![Phone: Mara passes and wins Defence of Dale](./screenshots/033-win-defence-dale-phone.png)

![Desktop: Mara passes and wins Defence of Dale](./screenshots/033-win-defence-dale-desktop.png)
...
## Mara reloads the selected Battle reward

![Phone: Mara reloads the selected Battle reward](./screenshots/034-reload-defence-dale-phone.png)

![Desktop: Mara reloads the selected Battle reward](./screenshots/034-reload-defence-dale-desktop.png)

**Verifications:**

- [x] The exact reward, trophy, and round-three authority replay immutably
- [x] Every connected browser replays 26 accepted events with no diagnostics
