# Test: Master of Lake-town Gold and Fate economy
...
![Phone: Rin selects Armed Escort](./screenshots/017-select-hall-escort-1-phone.png)

![Desktop: Rin selects Armed Escort](./screenshots/017-select-hall-escort-1-desktop.png)

**Verifications:**

- [x] The selected card’s final printed icon enables the intended destination

---

## Rin takes a seat in the Hall of Fire

![Phone: Rin takes a seat in the Hall of Fire](./screenshots/018-take-hall-fire-2-phone.png)

![Desktop: Rin takes a seat in the Hall of Fire](./screenshots/018-take-hall-fire-2-desktop.png)

**Verifications:**

- [x] The real Council destination is occupied and its Fate draw pauses at Foresight
...
![Phone: Rin resolves Foresight and takes Divided Counsel](./screenshots/019-choose-opening-master-foresight-phone.png)

![Desktop: Rin resolves Foresight and takes Divided Counsel](./screenshots/019-choose-opening-master-foresight-desktop.png)
...
![Phone: Pip Reveals the real remaining hand](./screenshots/020-reveal-3-phone.png)

![Desktop: Pip Reveals the real remaining hand](./screenshots/020-reveal-3-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/021-finish-4-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/021-finish-4-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/022-reveal-5-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/022-reveal-5-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/023-finish-6-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/023-finish-6-desktop.png)
...
![Phone: Rin Reveals the real remaining hand](./screenshots/024-reveal-7-phone.png)

![Desktop: Rin Reveals the real remaining hand](./screenshots/024-reveal-7-desktop.png)
...
## Rin acquires Master of Lake-town

![Phone: Rin acquires Master of Lake-town](./screenshots/025-acquire-master-8-phone.png)

![Desktop: Rin acquires Master of Lake-town](./screenshots/025-acquire-master-8-desktop.png)

**Verifications:**

- [x] The exact five-Influence physical card enters discard and its Row position refills
...
![Phone: Rin finishes Reveal](./screenshots/026-finish-9-phone.png)

![Desktop: Rin finishes Reveal](./screenshots/026-finish-9-desktop.png)
...
![Phone: Pip Reveals the real remaining hand](./screenshots/027-reveal-10-phone.png)

![Desktop: Pip Reveals the real remaining hand](./screenshots/027-reveal-10-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/028-finish-11-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/028-finish-11-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/029-reveal-12-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/029-reveal-12-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/030-finish-13-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/030-finish-13-desktop.png)
...
![Phone: Rin Reveals the real remaining hand](./screenshots/031-reveal-14-phone.png)

![Desktop: Rin Reveals the real remaining hand](./screenshots/031-reveal-14-desktop.png)
...
![Phone: Rin finishes Reveal](./screenshots/032-finish-15-phone.png)

![Desktop: Rin finishes Reveal](./screenshots/032-finish-15-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/033-reveal-16-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/033-reveal-16-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/034-finish-17-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/034-finish-17-desktop.png)
...
## Rin selects Master of Lake-town

![Phone: Rin selects Master of Lake-town](./screenshots/035-select-master-18-phone.png)

![Desktop: Rin selects Master of Lake-town](./screenshots/035-select-master-18-desktop.png)
...
## Rin sends the Master to Muster of the Free Peoples

![Phone: Rin sends the Master to Muster of the Free Peoples](./screenshots/036-play-master-19-phone.png)

![Desktop: Rin sends the Master to Muster of the Free Peoples](./screenshots/036-play-master-19-desktop.png)

**Verifications:**

- [x] The Journey grants exactly three Gold before the destination choice resolves
- [x] Only the acting owner can resolve the ordered Council choice
- [x] Every connected browser replays 28 accepted events with no diagnostics

---

## Rin keeps the Master’s Gold

![Phone: Rin keeps the Master’s Gold](./screenshots/037-decline-council-20-phone.png)

![Desktop: Rin keeps the Master’s Gold](./screenshots/037-decline-council-20-desktop.png)

**Verifications:**

- [x] The destination closes without spending any of the three Journey Gold
...
![Phone: Pip Reveals the real remaining hand](./screenshots/038-reveal-21-phone.png)

![Desktop: Pip Reveals the real remaining hand](./screenshots/038-reveal-21-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/039-finish-22-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/039-finish-22-desktop.png)
...
![Phone: Rin Reveals the real remaining hand](./screenshots/040-reveal-23-phone.png)

![Desktop: Rin Reveals the real remaining hand](./screenshots/040-reveal-23-desktop.png)
...
![Phone: Rin finishes Reveal](./screenshots/041-finish-24-phone.png)

![Desktop: Rin finishes Reveal](./screenshots/041-finish-24-desktop.png)
...
![Phone: Rin Reveals the real remaining hand](./screenshots/042-reveal-25-phone.png)

![Desktop: Rin Reveals the real remaining hand](./screenshots/042-reveal-25-desktop.png)
...
![Phone: Rin finishes Reveal](./screenshots/043-finish-26-phone.png)

![Desktop: Rin finishes Reveal](./screenshots/043-finish-26-desktop.png)
...
![Phone: Pip Reveals the real remaining hand](./screenshots/044-reveal-27-phone.png)

![Desktop: Pip Reveals the real remaining hand](./screenshots/044-reveal-27-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/045-finish-28-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/045-finish-28-desktop.png)
...
![Phone: Pip Reveals the real remaining hand](./screenshots/048-reveal-31-phone.png)

![Desktop: Pip Reveals the real remaining hand](./screenshots/048-reveal-31-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/049-finish-32-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/049-finish-32-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/050-reveal-33-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/050-reveal-33-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/051-finish-34-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/051-finish-34-desktop.png)
...
- [x] The public Muster row replaces only the acting human’s private hand
- [x] Master of Lake-town contributes exactly three Influence and opens its optional Fate payment
- [x] Observers see the ordered choice but cannot spend another player’s Gold
- [x] Every connected browser replays 44 accepted events with no diagnostics

---

## Rin pays the Master for one Fate card

![Phone: Rin pays the Master for one Fate card](./screenshots/053-pay-master-fate-36-phone.png)

![Desktop: Rin pays the Master for one Fate card](./screenshots/053-pay-master-fate-36-desktop.png)

**Verifications:**

- [x] Exactly two Gold are spent before the private Fate choice resolves
- [x] The Fate draw pauses at Galadriel’s once-per-round Foresight without drawing early
- [x] Only Galadriel can identify and choose either exact Fate option
...
## Rin resolves Foresight and takes Sudden Charge

![Phone: Rin resolves Foresight and takes Sudden Charge](./screenshots/054-choose-master-paid-foresight-36-phone.png)

![Desktop: Rin resolves Foresight and takes Sudden Charge](./screenshots/054-choose-master-paid-foresight-36-desktop.png)
...
- [x] The unchosen exact Fate card goes to the deck bottom without entering the public discard
- [x] The private Commander choice closes before the interrupted effect continues
- [x] The paid physical Fate enters the private hand and Reveal resumes
...
## Rin reloads the Master’s completed economy

![Phone: Rin reloads the Master’s completed economy](./screenshots/056-reload-master-lake-town-phone.png)

![Desktop: Rin reloads the Master’s completed economy](./screenshots/056-reload-master-lake-town-desktop.png)

**Verifications:**

- [x] Replay preserves the acquisition, three-Gold Journey, two-Gold payment, private Fate draw, and authority
- [x] Every connected browser replays 47 accepted events with no diagnostics
