# Test: Three-player Agent, deck-building, Scout, Council, and ten-round tracer
...
- [x] Both of Galadriel’s implemented powers are visibly active
...
- [x] Both of Gandalf’s implemented powers are visibly active
...
## The selected Battle deck ends after round ten

![Phone: The selected Battle deck ends after round ten](./screenshots/124-ten-round-endgame-phone.png)

![Desktop: The selected Battle deck ends after round ten](./screenshots/124-ten-round-endgame-desktop.png)

**Verifications:**

- [x] Every human enters Endgame instead of an illegal eleventh round
- [x] Every connected replay has accepted exactly 87 events with no diagnostics
