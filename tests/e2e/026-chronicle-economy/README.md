...
![Phone: Mara acquires Delving Expedition](./screenshots/030-acquire-14-phone.png)

![Desktop: Mara acquires Delving Expedition](./screenshots/030-acquire-14-desktop.png)
...
![Phone: Mara acquires Voice of Orthanc](./screenshots/040-acquire-24-phone.png)

![Desktop: Mara acquires Voice of Orthanc](./screenshots/040-acquire-24-desktop.png)
...
![Phone: Mara selects Delving Expedition](./screenshots/052-select-36-phone.png)

![Desktop: Mara selects Delving Expedition](./screenshots/052-select-36-desktop.png)
...
![Phone: Mara plays Delving Expedition at its real destination](./screenshots/053-place-37-phone.png)

![Desktop: Mara plays Delving Expedition at its real destination](./screenshots/053-place-37-desktop.png)
...
![Phone: Mara takes Mithril at Entwash](./screenshots/054-delving-riches-38-phone.png)

![Desktop: Mara takes Mithril at Entwash](./screenshots/054-delving-riches-38-desktop.png)
...
![Phone: Mara keeps the expedition out of Battle](./screenshots/055-delving-deploy-39-phone.png)

![Desktop: Mara keeps the expedition out of Battle](./screenshots/055-delving-deploy-39-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/057-finish-41-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/057-finish-41-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/060-reveal-44-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/060-reveal-44-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/061-finish-45-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/061-finish-45-desktop.png)
...
![Phone: Rin Reveals the real remaining hand](./screenshots/062-reveal-46-phone.png)

![Desktop: Rin Reveals the real remaining hand](./screenshots/062-reveal-46-desktop.png)
...
![Phone: Mara selects Durin's Heir](./screenshots/064-select-48-phone.png)

![Desktop: Mara selects Durin's Heir](./screenshots/064-select-48-desktop.png)
...
![Phone: Mara plays Durin's Heir at its real destination](./screenshots/065-place-49-phone.png)

![Desktop: Mara plays Durin's Heir at its real destination](./screenshots/065-place-49-desktop.png)
...
![Phone: Pip Reveals the real remaining hand](./screenshots/068-reveal-52-phone.png)

![Desktop: Pip Reveals the real remaining hand](./screenshots/068-reveal-52-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/069-finish-53-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/069-finish-53-desktop.png)
...
![Phone: Mara selects Voice of Orthanc](./screenshots/070-select-54-phone.png)

![Desktop: Mara selects Voice of Orthanc](./screenshots/070-select-54-desktop.png)
...
![Phone: Mara plays Voice of Orthanc at its real destination](./screenshots/071-place-55-phone.png)

![Desktop: Mara plays Voice of Orthanc at its real destination](./screenshots/071-place-55-desktop.png)
...
![Phone: Mara reloads the completed economy batch](./screenshots/072-reload-economy-batch-phone.png)

![Desktop: Mara reloads the completed economy batch](./screenshots/072-reload-economy-batch-desktop.png)
