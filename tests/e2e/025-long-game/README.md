...
![Phone: Mara acquires Elven Foresight](./screenshots/024-acquire-6-phone.png)

![Desktop: Mara acquires Elven Foresight](./screenshots/024-acquire-6-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/025-finish-7-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/025-finish-7-desktop.png)
...
![Phone: Rin Reveals the remaining hand](./screenshots/026-reveal-8-phone.png)

![Desktop: Rin Reveals the remaining hand](./screenshots/026-reveal-8-desktop.png)
...
![Phone: Rin acquires Voice of Orthanc](./screenshots/027-acquire-9-phone.png)

![Desktop: Rin acquires Voice of Orthanc](./screenshots/027-acquire-9-desktop.png)
...
![Phone: Rin finishes Reveal](./screenshots/028-finish-10-phone.png)

![Desktop: Rin finishes Reveal](./screenshots/028-finish-10-desktop.png)
...
![Phone: Pip Reveals the remaining hand](./screenshots/029-reveal-11-phone.png)

![Desktop: Pip Reveals the remaining hand](./screenshots/029-reveal-11-desktop.png)
...
![Phone: Pip acquires Goblin Informer](./screenshots/030-acquire-12-phone.png)

![Desktop: Pip acquires Goblin Informer](./screenshots/030-acquire-12-desktop.png)
...
## Pip acquires Messenger Moth

![Phone: Pip acquires Messenger Moth](./screenshots/031-acquire-13-phone.png)

![Desktop: Pip acquires Messenger Moth](./screenshots/031-acquire-13-desktop.png)
...
![Phone: Mara acquires Rider of Rohan](./screenshots/034-acquire-16-phone.png)

![Desktop: Mara acquires Rider of Rohan](./screenshots/034-acquire-16-desktop.png)
...
![Phone: Rin acquires Dwarven Smith](./screenshots/038-acquire-20-phone.png)

![Desktop: Rin acquires Dwarven Smith](./screenshots/038-acquire-20-desktop.png)
...
![Phone: Mara acquires Envoy of Dale](./screenshots/041-acquire-23-phone.png)

![Desktop: Mara acquires Envoy of Dale](./screenshots/041-acquire-23-desktop.png)
...
![Phone: Rin acquires Eagle of the Misty Mountains](./screenshots/044-acquire-26-phone.png)

![Desktop: Rin acquires Eagle of the Misty Mountains](./screenshots/044-acquire-26-desktop.png)
...
## Rin acquires Khazad Guard

![Phone: Rin acquires Khazad Guard](./screenshots/049-acquire-31-phone.png)

![Desktop: Rin acquires Khazad Guard](./screenshots/049-acquire-31-desktop.png)
...
![Phone: Pip acquires Uruk-hai Captain](./screenshots/052-acquire-34-phone.png)

![Desktop: Pip acquires Uruk-hai Captain](./screenshots/052-acquire-34-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/053-finish-35-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/053-finish-35-desktop.png)
...
![Phone: Mara acquires Lore of Imladris](./screenshots/055-acquire-37-phone.png)

![Desktop: Mara acquires Lore of Imladris](./screenshots/055-acquire-37-desktop.png)
...
## Mara acquires Warden of Ithilien

![Phone: Mara acquires Warden of Ithilien](./screenshots/056-acquire-38-phone.png)

![Desktop: Mara acquires Warden of Ithilien](./screenshots/056-acquire-38-desktop.png)
...
![Phone: Pip acquires Uruk-hai Captain](./screenshots/059-acquire-41-phone.png)

![Desktop: Pip acquires Uruk-hai Captain](./screenshots/059-acquire-41-desktop.png)
...
![Phone: Mara Reveals the remaining hand](./screenshots/061-reveal-43-phone.png)

![Desktop: Mara Reveals the remaining hand](./screenshots/061-reveal-43-desktop.png)
...
![Phone: Mara acquires Delving Expedition](./screenshots/062-acquire-44-phone.png)

![Desktop: Mara acquires Delving Expedition](./screenshots/062-acquire-44-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/063-finish-45-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/063-finish-45-desktop.png)
...
![Phone: Rin Reveals the remaining hand](./screenshots/064-reveal-46-phone.png)

![Desktop: Rin Reveals the remaining hand](./screenshots/064-reveal-46-desktop.png)
...
![Phone: Rin acquires Voice of Orthanc](./screenshots/065-acquire-47-phone.png)

![Desktop: Rin acquires Voice of Orthanc](./screenshots/065-acquire-47-desktop.png)
...
![Phone: Rin finishes Reveal](./screenshots/066-finish-48-phone.png)

![Desktop: Rin finishes Reveal](./screenshots/066-finish-48-desktop.png)
...
![Phone: Mara acquires Ranger of the North](./screenshots/068-acquire-50-phone.png)

![Desktop: Mara acquires Ranger of the North](./screenshots/068-acquire-50-desktop.png)
...
![Phone: Mara acquires Captain of Gondor](./screenshots/069-acquire-51-phone.png)

![Desktop: Mara acquires Captain of Gondor](./screenshots/069-acquire-51-desktop.png)
...
![Phone: Rin acquires Lady of the Golden Wood](./screenshots/072-acquire-54-phone.png)

![Desktop: Rin acquires Lady of the Golden Wood](./screenshots/072-acquire-54-desktop.png)
...
![Phone: Pip Reveals the remaining hand](./screenshots/074-reveal-56-phone.png)

![Desktop: Pip Reveals the remaining hand](./screenshots/074-reveal-56-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/075-finish-57-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/075-finish-57-desktop.png)
...
![Phone: Rin selects Lady of the Golden Wood](./screenshots/076-select-lady-58-phone.png)

![Desktop: Rin selects Lady of the Golden Wood](./screenshots/076-select-lady-58-desktop.png)
...
![Phone: Rin sends the Lady to Hidden Counsel](./screenshots/077-play-lady-59-phone.png)

![Desktop: Rin sends the Lady to Hidden Counsel](./screenshots/077-play-lady-59-desktop.png)
...
![Phone: Rin places the Lady's Scout](./screenshots/078-place-lady-scout-60-phone.png)

![Desktop: Rin places the Lady's Scout](./screenshots/078-place-lady-scout-60-desktop.png)
...
![Phone: Rin plays The Long Game](./screenshots/103-play-long-game-phone.png)

![Desktop: Rin plays The Long Game](./screenshots/103-play-long-game-desktop.png)
...
![Phone: Rin passes final scoring](./screenshots/104-final-pass-1-phone.png)

![Desktop: Rin passes final scoring](./screenshots/104-final-pass-1-desktop.png)
...
![Phone: Pip passes final scoring](./screenshots/105-final-pass-2-phone.png)

![Desktop: Pip passes final scoring](./screenshots/105-final-pass-2-desktop.png)
...
![Phone: Mara passes final scoring](./screenshots/106-final-pass-3-phone.png)

![Desktop: Mara passes final scoring](./screenshots/106-final-pass-3-desktop.png)
...
![Phone: Rin reloads the finished Long Game](./screenshots/107-reload-long-game-result-phone.png)

![Desktop: Rin reloads the finished Long Game](./screenshots/107-reload-long-game-result-desktop.png)
