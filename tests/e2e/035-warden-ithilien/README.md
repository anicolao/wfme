# Test: Warden of Ithilien Battle-connected Scout
...
![Phone: Pip acquires Warden of Ithilien](./screenshots/018-acquire-warden-ithilien-phone.png)

![Desktop: Pip acquires Warden of Ithilien](./screenshots/018-acquire-warden-ithilien-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/019-finish-2-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/019-finish-2-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/020-reveal-3-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/020-reveal-3-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/021-finish-4-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/021-finish-4-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/024-reveal-7-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/024-reveal-7-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/025-finish-8-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/025-finish-8-desktop.png)
...
![Phone: Pip Reveals the real remaining hand](./screenshots/028-reveal-11-phone.png)

![Desktop: Pip Reveals the real remaining hand](./screenshots/028-reveal-11-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/029-finish-12-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/029-finish-12-desktop.png)
...
![Phone: Pip Reveals the real remaining hand](./screenshots/032-reveal-15-phone.png)

![Desktop: Pip Reveals the real remaining hand](./screenshots/032-reveal-15-desktop.png)

**Verifications:**

- [x] The public Muster row replaces only the acting human’s private hand
- [x] Warden of Ithilien contributes its final 2 Influence and 1 sword Muster box
...
![Phone: Pip finishes Reveal](./screenshots/033-finish-16-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/033-finish-16-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/034-reveal-17-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/034-reveal-17-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/035-finish-18-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/035-finish-18-desktop.png)
...
![Phone: Pip Reveals the real remaining hand](./screenshots/036-reveal-19-phone.png)

![Desktop: Pip Reveals the real remaining hand](./screenshots/036-reveal-19-desktop.png)
...
![Phone: Pip finishes Reveal](./screenshots/037-finish-20-phone.png)

![Desktop: Pip finishes Reveal](./screenshots/037-finish-20-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/038-reveal-21-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/038-reveal-21-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/039-finish-22-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/039-finish-22-desktop.png)
...
![Phone: Mara Reveals the real remaining hand](./screenshots/042-reveal-25-phone.png)

![Desktop: Mara Reveals the real remaining hand](./screenshots/042-reveal-25-desktop.png)
...
![Phone: Mara finishes Reveal](./screenshots/043-finish-26-phone.png)

![Desktop: Mara finishes Reveal](./screenshots/043-finish-26-desktop.png)
...
## Pip selects Warden of Ithilien

![Phone: Pip selects Warden of Ithilien](./screenshots/046-select-warden-29-phone.png)

![Desktop: Pip selects Warden of Ithilien](./screenshots/046-select-warden-29-desktop.png)

**Verifications:**

- [x] Its final Wild icon enables the Battle space at Hidden Paths

---

## Pip sends the Warden to Hidden Paths

![Phone: Pip sends the Warden to Hidden Paths](./screenshots/047-play-warden-30-phone.png)

![Desktop: Pip sends the Warden to Hidden Paths](./screenshots/047-play-warden-30-desktop.png)

**Verifications:**

- [x] The owner must place the Warden Scout before resolving queued Battle deployment
- [x] Other humans can inspect but cannot place the restricted Scout
- [x] Every connected browser replays 40 accepted events with no diagnostics

---

## Pip places the Warden Scout at Muster Field

![Phone: Pip places the Warden Scout at Muster Field](./screenshots/048-place-warden-scout-31-phone.png)

![Desktop: Pip places the Warden Scout at Muster Field](./screenshots/048-place-warden-scout-31-desktop.png)

**Verifications:**

- [x] Exactly one finite Scout occupies the legal Battle-connected post
...
![Phone: Pip leaves Companies in garrison](./screenshots/049-finish-warden-deployment-32-phone.png)

![Desktop: Pip leaves Companies in garrison](./screenshots/049-finish-warden-deployment-32-desktop.png)

**Verifications:**

- [x] The ordered Battle choice closes only after the real deployment gesture
- [x] Every connected browser replays 42 accepted events with no diagnostics

---

## Pip reloads the Warden outcome

![Phone: Pip reloads the Warden outcome](./screenshots/050-reload-warden-ithilien-phone.png)

![Desktop: Pip reloads the Warden outcome](./screenshots/050-reload-warden-ithilien-desktop.png)

**Verifications:**

- [x] Replay preserves the exact Warden journey, legal Scout post, destination, and authority
- [x] Every connected browser replays 42 accepted events with no diagnostics
