# Test: Tidings from Afar Plot Fate tracer
...
![Phone: Rin selects Armed Escort](./screenshots/017-select-hall-card-phone.png)

![Desktop: Rin selects Armed Escort](./screenshots/017-select-hall-card-desktop.png)
...
## Rin enters Hall of Fire

![Phone: Rin enters Hall of Fire](./screenshots/018-enter-hall-phone.png)

![Desktop: Rin enters Hall of Fire](./screenshots/018-enter-hall-desktop.png)
...
## Rin resolves Foresight and takes Tidings from Afar

![Phone: Rin resolves Foresight and takes Tidings from Afar](./screenshots/019-choose-tidings-foresight-phone.png)

![Desktop: Rin resolves Foresight and takes Tidings from Afar](./screenshots/019-choose-tidings-foresight-desktop.png)
...
## Rin plays Tidings from Afar

![Phone: Rin plays Tidings from Afar](./screenshots/024-play-tidings-phone.png)

![Desktop: Rin plays Tidings from Afar](./screenshots/024-play-tidings-desktop.png)

**Verifications:**

- [x] The Fate card becomes public and opens its exact private top-deck choice
- [x] The owner receives two cards while observers receive only opaque disabled controls
- [x] Every connected browser replays 17 accepted events with no diagnostics

---

## Rin reloads during the private top-deck choice

![Phone: Rin reloads during the private top-deck choice](./screenshots/025-reload-pending-top-deck-phone.png)

![Desktop: Rin reloads during the private top-deck choice](./screenshots/025-reload-pending-top-deck-desktop.png)

**Verifications:**

- [x] The authorized private choice survives immutable replay
- [x] Both drawn cards remain in hand until the player chooses
- [x] Every connected browser replays 17 accepted events with no diagnostics

---

## Rin puts Rallying Words on top

![Phone: Rin puts Rallying Words on top](./screenshots/026-choose-top-card-phone.png)

![Desktop: Rin puts Rallying Words on top](./screenshots/026-choose-top-card-desktop.png)

**Verifications:**

- [x] The hand keeps the net one-card gain and the ordered choice closes
