...
![Phone: Rin plays Tidings from Afar](./screenshots/023-play-tidings-phone.png)

![Desktop: Rin plays Tidings from Afar](./screenshots/023-play-tidings-desktop.png)
...
![Phone: Rin reloads during the private top-deck choice](./screenshots/024-reload-pending-top-deck-phone.png)

![Desktop: Rin reloads during the private top-deck choice](./screenshots/024-reload-pending-top-deck-desktop.png)
...
![Phone: Rin puts Rallying Words on top](./screenshots/025-choose-top-card-phone.png)

![Desktop: Rin puts Rallying Words on top](./screenshots/025-choose-top-card-desktop.png)
