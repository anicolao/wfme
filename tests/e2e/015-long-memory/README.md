# Test: Long Memory Plot Fate tracer
...
- [x] All observers see the public occupation and one private Fate card
- [x] Only the owner can identify Long Memory before it is played
...
- [x] The actual hand becomes a public Muster row
...
- [x] Turn authority advances without exposing the private Fate identity
...
## Pip plays Long Memory

![Phone: Pip plays Long Memory](./screenshots/023-play-long-memory-phone.png)

![Desktop: Pip plays Long Memory](./screenshots/023-play-long-memory-desktop.png)

**Verifications:**

- [x] The Fate identity becomes public and an affordable Chronicle choice opens
- [x] Observers see the public choice but cannot make it for the actor
- [x] Every connected browser replays 16 accepted events with no diagnostics

---

## Pip reloads during the Chronicle choice

![Phone: Pip reloads during the Chronicle choice](./screenshots/024-reload-memory-choice-phone.png)

![Desktop: Pip reloads during the Chronicle choice](./screenshots/024-reload-memory-choice-desktop.png)

**Verifications:**

- [x] The exact public options and actor authority survive immutable replay
- [x] Every connected browser replays 16 accepted events with no diagnostics
...
## Pip selects The Open Road after Long Memory

![Phone: Pip selects The Open Road after Long Memory](./screenshots/026-select-resumed-card-phone.png)

![Desktop: Pip selects The Open Road after Long Memory](./screenshots/026-select-resumed-card-desktop.png)

**Verifications:**

- [x] A real Roads destination is enabled in the resumed turn

---

## Pip continues to Take Up a War Effort

![Phone: Pip continues to Take Up a War Effort](./screenshots/027-continue-agent-turn-phone.png)

![Desktop: Pip continues to Take Up a War Effort](./screenshots/027-continue-agent-turn-desktop.png)

**Verifications:**

- [x] The remaining Agent resolves a real board reward for every observer
